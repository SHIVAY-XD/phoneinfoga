...
build:
	go generate ./...
	go build -v -ldflags="-s -w -X 'github.com/TEAMSTARWORLD/phoneinfoga/v2/build.Version=${GIT_TAG}' -X 'github.com/TEAMSTARWORLD/phoneinfoga/v2/build.Commit=${GIT_COMMIT}'" -o ./bin/phoneinfoga .
